...
![atomicparsley](https://repo.x-cmd.io/atomicparsley.svg?lang=zh)
...
合计: **20,556** 行代码（覆盖前 5 种语言、共 **26** 个文件）。
...
- **上游仓库**: <https://github.com/wez/atomicparsley>
- **官网**: <https://github.com/wez/atomicparsley>
- **许可证**: GPL-2.0

## 发布

- **最新版本**: `20240608.083822.1ed9031` (2024-06-08)
- **最近提交**: 2024-12-04
- **Release 含资产**: 5 个

## 流行度

- **Star**: 767 · **Fork**: 75 · **开放 issue**: 43 · **贡献者**: 22

## 累计统计

- **发布数**: 8 · **已合并 PR**: 22 · **开放 PR**: 4 · **已关闭 issue**: 25 · **开放 issue**: 18 · **提交数**: 193
...
在 [repology.org](https://repology.org/project/atomicparsley) 上共有 **90** 个发行版报告此项目。**35** 个 ✅ 已是最新上游版本，**49** 个 ⚠️ 使用旧版本。
...
atomicparsley 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `atomicparsley` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/atomicparsley.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T04:49:15Z._
